            ...
            <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex md:items-center lg:justify-center md:mr-8 md:justify-center flex-1 px-2">
                    <div className="flex space-x-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-1 rounded-lg shadow-inner">
                        <Link href="/dashboard">
                            <button 
                                className={`inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-md transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 ${
                                    isActive('/dashboard')
                ...
                <div className="flex items-center">
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            ...
                            <hr className="border-gray-200 dark:border-gray-700" />
                            <div className="py-2 flex items-center justify-center w-full space-x-4 px-4">
                                {/* Time Display on the Left */}
                                <h2 className="text-sm font-medium text-gray-700 dark:text-gray-300">{isTimeIn ? "Time in" : "Time out"}</h2>
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    ...
                                    />
                                    <div className={`w-11 h-6 rounded-full transition-colors duration-300 ${isTimeIn ? 'bg-green-500 peer-focus:ring-green-300' : 'bg-red-500 peer-focus:ring-red-300'
