...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Top navigation */}
            <nav className=" dark:bg-gray-800 text-black border-b-2">
                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            <div className="relative">
                                <Link href="/dashboard">
                                    <button className="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-black dark:bg-gray-800 hover:text-green-300 focus:outline-none ">
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            <div className="relative">
                                <form onSubmit={logout}>
                                    <button type='submit' className="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-black dark:bg-gray-800 hover:text-green-300 focus:outline-none ">
                                        <span className="block h-9 mt-3 w-auto fill-current text-lg text-black hover:text-green-300">
                                          <b>Logout</b>
                                        </span>
                                    </button>
                                </form>
