...
{/* Animated Sidebar */}
<div 
  className={`bg-gray-300 text-black w-80 fixed h-full shadow-xl transition-all duration-300 ease-in-out z-50 ${
  ...
  <div className="absolute bottom-0 w-full p-4 border-t border-gray-400">
    ...
    <div className="flex items-center justify-center">
        <Image 
            ...
            className="rounded-full cursor-pointer hover:shadow-md transition-all duration-300"
            alt="User dropdown" 
        />
    </div>
