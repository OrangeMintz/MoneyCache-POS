        ...
        <div
            ...
            <div class="relative w-full">
                {{-- <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="lg:col-start-1"></div> <!-- Removed the Laravel logo -->
                    ...
                    <section class="dark:bg-gray-900 py-14">
                        <div class="grid max-w-screen-xl px-4 py-8 mx-auto md:gap-8 xl:gap-0 md:py-16 md:grid-cols-12">
                            <div
                                ...
                                <h1
                                    class="max-w-2xl mb-4 text-4xl text-[#3A3A3A] font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-MCGreen hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 w-full md:w-auto">
                                        Sign Up
                        ...
                        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                            ...
                            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
                                ...
                                <div>
                                    <div
                                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                        <svg class="w-8 h-8 text-[#3FA3DA] lg:w-6 lg:h-6 dark:text-primary-300"
                                            fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
