      ...
      <div class="bg-white p-4 mb-4">
          <div class="card-header flex justify-between items-center">
              ...
              <div class="flex flex-wrap justify-center">
                  <a href="{{ route('pdf') }}"
                      class="bg-emerald-700 hover:bg-emerald-900 rounded-lg text-white text-md text-center self-center px-3 py-2 my-2 mx-2">Add User</a>
              </div>
          </div>
                  ...
                  <tr>
                      ...
                      <td>                    
                        <div style="display: flex; gap: 0.5rem; justify-content: center;">
                          <button data-modal-target="edit-modal"  class="w-20 px-3 py-1 text-white bg-blue-500 rounded hover:bg-blue-600"
                              data-modal-toggle="add-modal">Edit</button>
                          <form method="POST" class="delete-form" href="" action="" onsubmit="return confirmation(event)">
                              @csrf
                              @method('DELETE')
