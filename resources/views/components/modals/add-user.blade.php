<!-- Main Modal -->
<div id="add-user-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex items-center justify-center">
  <!-- Overlay -->
  ...
  <div class="relative p-4 w-full max-w-md bg-white rounded-lg shadow dark:bg-gray-700 z-50">
      ...
      <form class="p-1 md:p-2">
          ...
          <button type="submit" class="w-full py-2.5 px-5 text-sm font-medium text-white bg-emerald-700 hover:bg-emerald-900 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center justify-center">
