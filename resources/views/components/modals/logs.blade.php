        ...
        function format(d) {
            ...
            <div class="child-row">
                ...
                <div class="details-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg p-5">
                    ...
                    <div class="relative bg-gray-50 dark:bg-gray-700 dark:border-gray-600 p-4 rounded-lg border border-gray-200 grid grid-cols-3">
                        
                        <!-- User Image Column -->
                        <div class="flex justify-start items-center">

                            <img src="${(d.attendance && d.attendance.photo) ? d.attendance.photo : 
                            (d.user && d.user.photo) ? d.user.photo : 
                            (d.transaction && d.transaction.photo) ? d.transaction.photo : userPlaceholderImage}" 
                            alt="Photo" class="w-24 h-24 object-cover rounded-full border-2 border-gray-300 shadow-sm">
                        </div>
                        <div class="text-sm space-y-1 text-gray-500 dark:text-gray-400 leading-loose hidden sm:block">
                            ${getFieldLabels(d)}
                        </div>
